...
class OwnerControllerTest {
    ...
    //sets up controller with mocks injected.
    @InjectMocks
    ...
    void setUp() {
        ...
        //standaloneSetup is a lighterweight way to set up a mock controller.
        //doesn't actually bring up a server.
    ...
    void listOfOwners() throws Exception {
        ...
        mockMvc.perform(get("/owners"))
                .andExpect(status().isOk())//status of 200
